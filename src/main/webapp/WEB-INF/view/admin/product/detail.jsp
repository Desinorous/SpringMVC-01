                                            ...
                                            <div class="card" style="width: 60%;">
                                                ...
                                                <ul class="list-group list-group-flush">
                                                    <li class="list-group-item"><img
                                                            ...
                                                            src="/img/product/${product.image}" alt=""></li>
                                                    ...
                                                    <li class="list-group-item">Quanity: ${product.quantity}</li>
                                                    <li class="list-group-item">Price: ${product.price} VND</li>
                                                    <li class="list-group-item">Factory: ${product.factory}</li>
                                                </ul>
                                            </div>

                                            <a href="/admin/product" class="btn btn-primary mt-4">Return</a>
                                        </div>
